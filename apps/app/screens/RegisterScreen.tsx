...
export default function RegisterScreen({
  ...
  // const [oprfChallenge, setOprfChallenge] =  useState('')
  // const [randomScalar, setRandomScalar] =  useState('')
  // const [serverChallengeResponse, setServerChallengeResponse] =  useState('')
  // const [serverPublicKey, setServerPublicKey] =  useState('')
  // const [oprfPublicKey, setOprfPublicKey] =  useState('');
